...
public class PasswordUtils {
    ...
    /*
     * public static void main(final String[] args) throws Exception { final
     * String originalPassword = "secret";
     * System.out.println("Original password: " + originalPassword); final
     * String encryptedPassword = encrypt(originalPassword);
     * System.out.println("Encrypted password: " + encryptedPassword); final
     * String decryptedPassword = decrypt(encryptedPassword);
     * System.out.println("Decrypted password: " + decryptedPassword); }
     */

    private static String encrypt(final String property) throws GeneralSecurityException, UnsupportedEncodingException {
    ...
    public static String decrypt(final String property) throws GeneralSecurityException, IOException {
        final SecretKeyFactory keyFactory = SecretKeyFactory.getInstance("PBEWithMD5AndDES");
        final SecretKey key = keyFactory.generateSecret(new PBEKeySpec(PASSWORD));
        final Cipher pbeCipher = Cipher.getInstance("PBEWithMD5AndDES");

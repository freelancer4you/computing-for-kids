create table course_participants (course_name varchar(255) not null, user_id varchar(255) not null, primary key (course_name, user_id)); 
...
alter table course_participants add constraint fk_cp_defaultaccount_id foreign key (user_id) references default_account;
alter table course_participants add constraint fk_cp_googleaccount_id foreign key (user_id) references google_account;

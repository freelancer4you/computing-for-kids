...
insert into courses(name, icon, description, level, price) values ('Lego Programmierung', 'ev3.png', FILE_READ('classpath:lego-kurs-beschreibung.dat'), 'Beginner', 540.99);
insert into courses(name, icon, description, level, price) values ('Javascript for Kids', 'javascript.jpg', FILE_READ('classpath:javascript-kurs-beschreibung.dat'), 'Beginner', 495.99);
insert into courses(name, icon, description, level, price) values('VEX IQ Programmierung', 'lex.jpg', FILE_READ('classpath:vex-kurs-beschreibung.dat'), 'Beginner', 540.99);

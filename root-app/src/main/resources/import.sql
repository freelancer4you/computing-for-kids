...
insert into courses(id, name, icon, description, level, price, place, curriculum, appointments, duration, requirements, begindate, enddate) values('VexOct2016', 'VEX IQ Programmierung', 'lex.jpg', FILE_READ('classpath:vex-kurs-beschreibung.dat'), 'Beginner', 540.99, 'Volkshochschule, Löhrstraße 3 - 7', 'vex-curriculum', 'javascript-appointments', '18 Termine Veranstaltung(en), 54 Unterrichtseinheit(en)', 'Eigener Laptop', TO_TIMESTAMP('2016-01-31 10:10:10', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2017-01-31 10:10:10', 'YYYY-MM-DD HH24:MI:SS'));

...
insert into courses(name, icon, description, level, price, place, curriculum, appointments, duration, requirements) values ('Lego Programmierung', 'ev3.png', FILE_READ('classpath:lego-kurs-beschreibung.dat'), 'Beginner', 540.99, 'Volkshochschule, Löhrstraße 3 - 7', 'lego-curriculum', 'lego-appointments', '18 Termine Veranstaltung(en), 54 Unterrichtseinheit(en)', 'Eigener Laptop');
insert into courses(name, icon, description, level, price, place, curriculum, appointments, duration, requirements) values ('Javascript for Kids', 'javascript.jpg', FILE_READ('classpath:javascript-kurs-beschreibung.dat'), 'Beginner', 495.99, 'Volkshochschule, Löhrstraße 3 - 7', 'vex-curriculum', 'vex-appointments', '18 Termine Veranstaltung(en), 54 Unterrichtseinheit(en)', 'Eigener Laptop');
insert into courses(name, icon, description, level, price, place, curriculum, appointments, duration, requirements) values('VEX IQ Programmierung', 'lex.jpg', FILE_READ('classpath:vex-kurs-beschreibung.dat'), 'Beginner', 540.99, 'Volkshochschule, Löhrstraße 3 - 7', 'javascript-curriculum', 'javascript-appointments', '18 Termine Veranstaltung(en), 54 Unterrichtseinheit(en)', 'Eigener Laptop');

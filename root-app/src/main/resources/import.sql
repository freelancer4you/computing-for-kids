...
--Mai
insert into courses(id, name, icon, description, level, price, place, curriculum, appointments, duration_desc, duration_weeks, requirements, begindate) values ('LegoEinsMai2017', 'Lego Programmierung', 'ev3.png', FILE_READ('classpath:lego-kurs-beschreibung.dat'), 'Beginner', 210.00, 'Chopinstraße 9A, 04103 Leipzig', 'lego-curriculum', 'lego-mar-appointments', '10 Termine Veranstaltung(en), 20 Unterrichtseinheit(en)', 16, 'Eigener Laptop', TO_TIMESTAMP('2017-05-05 10:10:10', 'YYYY-MM-DD HH24:MI:SS'));
insert into courses(id, name, icon, description, level, price, place, curriculum, appointments, duration_desc, duration_weeks, requirements, begindate) values ('LegoZweiMai2017', 'Lego Programmierung', 'ev3.png', FILE_READ('classpath:lego-kurs-beschreibung.dat'), 'Beginner', 210.00, 'Chopinstraße 9A, 04103 Leipzig', 'lego-curriculum', 'lego-feb-appointments', '10 Termine Veranstaltung(en), 20 Unterrichtseinheit(en)', 16, 'Eigener Laptop', TO_TIMESTAMP('2017-05-06 13:30:00', 'YYYY-MM-DD HH24:MI:SS'));

...
--Mai
insert into courses(id, name, icon, description, level, price, place, curriculum, appointments, duration_desc, duration_weeks, requirements, begindate) values('VexMai2017', 'VEX IQ Programmierung', 'lex.jpg', 'TODO', 'Beginner', 190.00, 'Chopinstraße 9A, 04103 Leipzig', 'vex-curriculum', 'vex-feb-appointments', '10 Termine Veranstaltung(en), 20 Unterrichtseinheit(en)', 16, 'Eigener Laptop', '2017-05-06 10:10:10') on duplicate key update id = 'VexMai2017';
insert into courses(id, name, icon, description, level, price, place, curriculum, appointments, duration_desc, duration_weeks, requirements, begindate) values ('LegoMaiEins2017', 'Lego Programmierung', 'ev3.png', 'TODO', 'Beginner', 210.00, 'Chopinstraße 9A, 04103 Leipzig', 'lego-curriculum', 'lego-feb-appointments', '10 Termine Veranstaltung(en), 20 Unterrichtseinheit(en)', 16, 'Eigener Laptop', '2017-05-05 10:10:10') on duplicate key update id = 'LegoMaiEins2017';
insert into courses(id, name, icon, description, level, price, place, curriculum, appointments, duration_desc, duration_weeks, requirements, begindate) values ('LegoMaiZwei2017', 'Lego Programmierung', 'ev3.png', 'TODO', 'Beginner', 210.00, 'Chopinstraße 9A, 04103 Leipzig', 'lego-curriculum', 'lego-mar-appointments', '10 Termine Veranstaltung(en), 20 Unterrichtseinheit(en)', 16, 'Eigener Laptop', '2017-05-06 10:10:10') on duplicate key update id = 'LegoMaiZwei2017';

...
--Mai
insert into courses(id, name, icon, description, level, price, place, curriculum, appointments, duration_desc, duration_weeks, requirements, begindate, timeofday) values('VexJuni2017', 'VEX IQ Programmierung', 'lex.jpg', 'TODO', 'Beginner', 190.00, 'Chopinstraße 9A, 04103 Leipzig', 'vex-curriculum', 'vex-feb-appointments', '10 Termine Veranstaltung(en), 20 Unterrichtseinheit(en)', 16, 'Eigener Laptop', '2017-06-10 10:00:00', '10:00 - 11:30 Uhr') on duplicate key update id = 'VexJuni2017';
insert into courses(id, name, icon, description, level, price, place, curriculum, appointments, duration_desc, duration_weeks, requirements, begindate, timeofday) values ('LegoJuniEins2017', 'Lego Programmierung', 'ev3.png', 'TODO', 'Beginner', 210.00, 'Chopinstraße 9A, 04103 Leipzig', 'lego-curriculum', 'lego-feb-appointments', '10 Termine Veranstaltung(en), 20 Unterrichtseinheit(en)', 16, 'Eigener Laptop', '2017-06-10 13:30:00', '13:30 - 15:00 Uhr') on duplicate key update id = 'LegoJuniEins2017';
insert into courses(id, name, icon, description, level, price, place, curriculum, appointments, duration_desc, duration_weeks, requirements, begindate, timeofday) values ('LegoJuniZwei2017', 'Lego Programmierung', 'ev3.png', 'TODO', 'Beginner', 210.00, 'Chopinstraße 9A, 04103 Leipzig', 'lego-curriculum', 'lego-mar-appointments', '10 Termine Veranstaltung(en), 20 Unterrichtseinheit(en)', 16, 'Eigener Laptop', '2017-06-16 17:00:10', '17:00 - 18:30 Uhr') on duplicate key update id = 'LegoJuniZwei2017';

...
@ActiveProfiles("test")
@ComponentScan(
{ "de.goldmann.apps.root.services" })
...
public class UserServiceTest
{
    ...
    {
        userService.createUser(getUser("firstname", "lastname", "test456", "", "Password3", false));
    }

    @Test(expected = IllegalArgumentException.class)
    public void testBlankPassword()
    {
        userService.createUser(getUser("firstname", "lastname", "test456", "test@gmail.com", "", false));
    }

    @Test(expected = IllegalArgumentException.class)
    public void testBlankUser()
    {
        userService.createUser(getUser("firstname", "lastname", "", "test@gmail.com", "Password3", false));
    }
    ...
    {
        userService.createUser(getUser("firstname", "lastname", "username", "test", "Password3", false));
    }

    @Test(expected = IllegalArgumentException.class)
    public void testPasswordPolicy()
    {
        userService.createUser(getUser("firstname", "lastname", "username", "test@gmail.com", "Password",
                false));
    }
    ...
    {
        userService
                .createUser(getUser("firstname", "lastname", "test", "test@gmail.com", "Password3", false));
    }

...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        ...
        //        .antMatchers("/partials/courses/details/lego-curriculum.html").permitAll()
        //        .antMatchers("/partials/courses/details/vex-curriculum.html").permitAll()
        .antMatchers("/partials/courses/details/**").permitAll()
        // TODO das eventuell nur mit Login
        //        .antMatchers("/partials/courses/details/index.html").permitAll()
